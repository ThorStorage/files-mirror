...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg += f"\n\nExample :-\n<code>/{BotCommands.WatchCommand} https://youtu.be/XsX3ATc3FbA 720 |MaxxRider</code>\n\n"
        msg += "This file will be downloaded in 720p quality and it's name will be <b>MaxxRider</b>"
    ...
    sendMessage(f"<b>Your YouTube Link has been ADDED for Mirror 😋</b>\n👉 Check /{BotCommands.StatusCommand}", bot, update)
    if len(Interval) == 0:
